...
class SekchamberSpider(scrapy.Spider):
    name = 'sekchamber'
    start_urls = ['https://business.sekchamber.com/list']

    custom_settings = {
        'FEED_URI': 'sekchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.sekchamber.com/list'
