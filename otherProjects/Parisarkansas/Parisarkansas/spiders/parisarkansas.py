...
class ParisarkansasSpider(scrapy.Spider):
    name = 'parisarkansas'
    start_urls = ['https://business.parisarkansas.com/list/']

    custom_settings = {
        'FEED_URI': 'parisarkansas.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.parisarkansas.com/list/'
            ...
            item['Lead_Source'] = 'parisarkansas'
