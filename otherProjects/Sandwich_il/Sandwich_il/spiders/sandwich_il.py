...
class SandwichIlSpider(scrapy.Spider):
    name = 'sandwich_il'
    start_urls = ['http://sandwich-il.chambermaster.com/list']

    custom_settings = {
        'FEED_URI': 'sandwich_il.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'http://sandwich-il.chambermaster.com/list'
            ...
            item['Lead_Source'] = 'sandwich-il.chambermaster'
