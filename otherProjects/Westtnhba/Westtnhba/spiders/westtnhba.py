...
class WesttnhbaSpider(scrapy.Spider):
    name = 'westtnhba'
    start_urls = ['https://builders.westtnhba.com/list/']

    custom_settings = {
        'FEED_URI': 'westtnhba.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://builders.westtnhba.com/list/'
            ...
            item['Lead_Source'] = 'builders.westtnhba'
