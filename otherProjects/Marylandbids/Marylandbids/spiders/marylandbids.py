...
class MarylandbidsSpider(scrapy.Spider):
    name = 'marylandbids'
    start_urls = ['https://www.marylandbids.us/maryland-contractors/category.htm']

    base_url = 'https://www.marylandbids.us{}'
    custom_settings = {
        'FEED_URI': 'marylandbids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.marylandbids.us/maryland-contractors/category.htm'
                item['Lead_Source'] = 'marylandbids'
                item['Occupation'] = 'Contractor'
                item['Record_Type'] = 'Person'
                item['Meta_Description'] = "Contractors in Maryland"
