...
class WaylandchamberSpider(scrapy.Spider):
    name = 'waylandchamber'
    start_urls = ['https://waylandchamber.chambermaster.com/list']

    custom_settings = {
        'FEED_URI': 'waylandchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://waylandchamber.chambermaster.com/list/'
            ...
            item['Lead_Source'] = 'waylandchamber'
