...
class NashvillechamberSpider(scrapy.Spider):
    name = 'nashvillechamber'
    start_urls = ['https://web.nashvillechamber.com/allcategories']

    base_url = 'https://web.nashvillechamber.com{}'
    custom_settings = {
        'FEED_URI': 'nashvillechamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.nashvillechamber.com/allcategories'
            item['Lead_Source'] = 'nashvillechamber'
