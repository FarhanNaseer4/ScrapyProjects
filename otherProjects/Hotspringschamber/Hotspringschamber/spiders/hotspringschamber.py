...
class HotspringschamberSpider(scrapy.Spider):
    name = 'hotspringschamber'
    start_urls = ['https://web.hotspringschamber.com/allcategories']

    base_url = 'https://web.hotspringschamber.com{}'
    custom_settings = {
        'FEED_URI': 'hotspringschamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.hotspringschamber.com/allcategories'
            item['Lead_Source'] = 'hotspringschamber'
