...
class DanvillechamberSpider(scrapy.Spider):
    name = 'danvillechamber'
    start_urls = ['https://business.danvillechamber.org/list']

    custom_settings = {
        'FEED_URI': 'danvillechamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.danvillechamber.org/list'
            ...
            item['Lead_Source'] = 'danvillechamber'
