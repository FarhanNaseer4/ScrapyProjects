...
class GreaterfortwayneincSpider(scrapy.Spider):
    name = 'greaterfortwayneinc'
    start_urls = ['https://business.greaterfortwayneinc.com/list']

    custom_settings = {
        'FEED_URI': 'greaterfortwayneinc.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.greaterfortwayneinc.com/list'
            ...
            item['Lead_Source'] = 'greaterfortwayneinc'
