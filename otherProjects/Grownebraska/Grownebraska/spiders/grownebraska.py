...
class GrownebraskaSpider(scrapy.Spider):
    name = 'grownebraska'
    start_urls = ['https://members.grownebraska.org/list/']

    custom_settings = {
        'FEED_URI': 'grownebraska.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://members.grownebraska.org/list/'
