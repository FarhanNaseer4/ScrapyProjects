...
class OxfordmsSpider(scrapy.Spider):
    name = 'oxfordms'
    start_urls = ['https://business.oxfordms.com/list']

    custom_settings = {
        'FEED_URI': 'oxfordms.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.oxfordms.com/list'
