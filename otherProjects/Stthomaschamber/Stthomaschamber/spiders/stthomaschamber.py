...
class StthomaschamberSpider(scrapy.Spider):
    name = 'stthomaschamber'
    start_urls = ['https://www.stthomaschamber.on.ca/list']

    custom_settings = {
        'FEED_URI': 'stthomaschamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://www.stthomaschamber.on.ca/list'
            ...
            item['Lead_Source'] = 'stthomaschamber'
