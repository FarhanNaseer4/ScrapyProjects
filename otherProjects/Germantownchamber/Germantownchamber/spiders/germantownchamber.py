...
class GermantownchamberSpider(scrapy.Spider):
    name = 'germantownchamber'
    start_urls = ['https://web.germantownchamber.com/allcategories']

    base_url = 'https://web.germantownchamber.com{}'
    custom_settings = {
        'FEED_URI': 'germantownchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.germantownchamber.com/allcategories'
            item['Lead_Source'] = 'germantownchamber'
