...
class ThomsonmcduffieSpider(scrapy.Spider):
    name = 'thomsonmcduffie'
    start_urls = ['https://www.thomsonmcduffiechamber.com/list']

    custom_settings = {
        'FEED_URI': 'thomsonmcduffie.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://www.thomsonmcduffiechamber.com/list'
            ...
            item['Lead_Source'] = 'thomsonmcduffiechamber'
