...
class HamptonroadschamberSpider(scrapy.Spider):
    name = 'hamptonroadschamber'
    start_urls = ['https://web.hamptonroadschamber.com/allcategories']

    base_url = 'https://web.hamptonroadschamber.com{}'
    custom_settings = {
        'FEED_URI': 'hamptonroadschamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.hamptonroadschamber.com/allcategories'
            item['Lead_Source'] = 'hamptonroadschamber'
