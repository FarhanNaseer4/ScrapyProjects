...
class NpconnectSpider(scrapy.Spider):
    name = 'npconnect'
    start_urls = ['https://info.npconnect.org/list']

    custom_settings = {
        'FEED_URI': 'npconnect.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://info.npconnect.org/list'
