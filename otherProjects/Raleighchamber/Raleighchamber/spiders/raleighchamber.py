...
class RaleighchamberSpider(scrapy.Spider):
    name = 'raleighchamber'
    start_urls = ['https://web.raleighchamber.org/allcategories']

    base_url = 'https://web.raleighchamber.org{}'
    custom_settings = {
        'FEED_URI': 'raleighchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.raleighchamber.org/allcategories'
            item['Lead_Source'] = 'raleighchamber'
