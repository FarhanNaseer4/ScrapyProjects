...
class KctechcouncilSpider(scrapy.Spider):
    name = 'kctechcouncil'
    start_urls = ['https://business.kctechcouncil.com/list/']

    custom_settings = {
        'FEED_URI': 'kctechcouncil.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.kctechcouncil.com/list/'
            ...
            item['Lead_Source'] = 'kctechcouncil'
