...
class MissoulachamberSpider(scrapy.Spider):
    name = 'missoulachamber'
    start_urls = ['https://web.missoulachamber.com/allcategories']

    base_url = 'https://web.missoulachamber.com{}'
    custom_settings = {
        'FEED_URI': 'missoulachamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.missoulachamber.com/allcategories'
            item['Lead_Source'] = 'missoulachamber'
