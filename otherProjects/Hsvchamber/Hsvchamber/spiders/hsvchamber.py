...
class HsvchamberSpider(scrapy.Spider):
    name = 'hsvchamber'
    start_urls = ['https://cm.hsvchamber.org/list']

    custom_settings = {
        'FEED_URI': 'hsvchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://cm.hsvchamber.org/list'
