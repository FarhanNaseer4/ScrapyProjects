...
class ClearlakeiowaSpider(scrapy.Spider):
    name = 'clearlakeiowa'
    start_urls = ['https://members.clearlakeiowa.com/list']

    custom_settings = {
        'FEED_URI': 'clearlakeiowa.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://members.clearlakeiowa.com/list'
            ...
            item['Lead_Source'] = 'clearlakeiowa'
