...
class LewisvillechamberSpider(scrapy.Spider):
    name = 'Lewisvillechamber'
    start_urls = ['https://business.lewisvillechamber.org/list']

    custom_settings = {
        'FEED_URI': 'lewisvillechamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.lewisvillechamber.org/list'
            ...
            item['Lead_Source'] = 'lewisvillechamber'
