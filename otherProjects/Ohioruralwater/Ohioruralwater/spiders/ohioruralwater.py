...
class OhioruralwaterSpider(scrapy.Spider):
    name = 'ohioruralwater'
    start_urls = ['https://web.ohioruralwater.org/allcategories']

    base_url = 'https://web.ohioruralwater.org{}'
    custom_settings = {
        'FEED_URI': 'ohioruralwater.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.ohioruralwater.org/allcategories'
            item['Lead_Source'] = 'ohioruralwater'
