...
class GreenvillencSpider(scrapy.Spider):
    name = 'greenvillenc'
    start_urls = ['https://business.greenvillenc.org/list/']

    custom_settings = {
        'FEED_URI': 'greenvillenc.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.greenvillenc.org/list/'
