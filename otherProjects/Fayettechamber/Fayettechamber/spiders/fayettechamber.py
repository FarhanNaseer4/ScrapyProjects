...
class FayettechamberSpider(scrapy.Spider):
    name = 'fayettechamber'
    start_urls = ['https://business.fayettechamber.org/list']

    custom_settings = {
        'FEED_URI': 'fayettechamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.fayettechamber.org/list'
            ...
            item['Lead_Source'] = 'fayettechamber'
