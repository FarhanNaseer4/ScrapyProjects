...
class MemphischamberSpider(scrapy.Spider):
    name = 'memphischamber'
    start_urls = ['https://members.memphischamber.com/list']

    custom_settings = {
        'FEED_URI': 'memphischamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://members.memphischamber.com/list'
            ...
            item['Lead_Source'] = 'memphischamber'
