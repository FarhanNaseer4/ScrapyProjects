...
class PleasanthillchamberSpider(scrapy.Spider):
    name = 'pleasanthillchamber'
    start_urls = ['https://www.pleasanthillchamber.com/list']

    custom_settings = {
        'FEED_URI': 'pleasanthillchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            item = response.meta['item']
            item['Business Name'] = response.css('div[id="content-320260"] p::text').get('').strip()
            ...
            item['Source_URL'] = 'https://www.pleasanthillchamber.com/list'
            ...
            item['Lead_Source'] = 'pleasanthillchamber'
