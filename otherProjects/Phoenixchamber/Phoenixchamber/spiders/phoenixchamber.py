...
class PhoenixchamberSpider(scrapy.Spider):
    name = 'phoenixchamber'
    start_urls = ['https://business.phoenixchamber.com/list']

    custom_settings = {
        'FEED_URI': 'phoenixchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.phoenixchamber.com/list'
            ...
            item['Lead_Source'] = 'phoenixchamber'
