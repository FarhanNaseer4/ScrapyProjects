...
class MountpleasantiowaSpider(scrapy.Spider):
    name = 'mountpleasantiowa'
    start_urls = ['http://business.mountpleasantiowa.org/list']

    custom_settings = {
        'FEED_URI': 'mountpleasantiowa.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'http://business.mountpleasantiowa.org/list'
            ...
            item['Lead_Source'] = 'mountpleasantiowa'
