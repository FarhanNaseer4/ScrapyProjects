...
class WhitewaterchamberSpider(scrapy.Spider):
    name = 'whitewaterchamber'
    start_urls = ['https://business.whitewaterchamber.com/list']

    custom_settings = {
        'FEED_URI': 'whitewaterchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.whitewaterchamber.com/list'
            ...
            item['Lead_Source'] = 'whitewaterchamber'
