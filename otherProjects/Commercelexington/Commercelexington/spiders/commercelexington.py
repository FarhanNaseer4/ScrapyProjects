...
class CommercelexingtonSpider(scrapy.Spider):
    name = 'commercelexington'
    start_urls = ['https://web.commercelexington.com/allcategories']

    base_url = 'https://web.commercelexington.com{}'
    custom_settings = {
        'FEED_URI': 'commercelexington.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.commercelexington.com/allcategories'
            item['Lead_Source'] = 'commercelexington'
