...
class TennesseebidsSpider(scrapy.Spider):
    name = 'tennesseebids'
    start_urls = ['https://www.tennesseebids.us/tennessee-contractors/category.htm']

    base_url = 'https://www.tennesseebids.us{}'
    custom_settings = {
        'FEED_URI': 'tennesseebids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.tennesseebids.us/tennessee-contractors/category.htm'
                item['Lead_Source'] = 'tennesseebids'
                item['Occupation'] = 'Government Contractors'
                item['Meta_Description'] = "Contractors in Tennessee"
